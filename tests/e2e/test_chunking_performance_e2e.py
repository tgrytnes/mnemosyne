"""
E2E performance benchmark for hybrid chunking.
"""
...
@pytest.mark.e2e
def test_hybrid_ingestion_under_time_limit(tmp_path, mocker):
    """Hybrid ingestion should complete under 30 minutes for 100 files."""
    for i in range(100):
