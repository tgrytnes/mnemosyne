...
class TestMarkdownSerialization:
    ...
    def test_serialize_escapes_special_yaml_characters(self):
        ...
        assert (
            "Project: With Special Characters" in markdown
            or '"Project: With Special Characters"' in markdown
        )
...
"""
        ...
        assert (
            expected_desc in project["description"]
            or project["description"].strip() == expected_desc.strip()
        )
