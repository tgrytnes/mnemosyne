...
def generate_quality_report(output_path: Path, weaviate_host: str = "localhost", weaviate_port: int = 8080) -> None:
    ...
    try:
        ...
        with open(output_path, "w") as f:
            ...
            f.write(f"- Embedding collapse detected: {'Yes' if embedding_metrics.embedding_collapse_detected else 'No'}\n")
